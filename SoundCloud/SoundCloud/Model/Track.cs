...
namespace SoundCloud.Model
{
    ...
    public class Track : SoundCloudClient
    {
        ...
        /// </summary>
        public static async Task<List<Track>> MyTacks()
        {
            return await SoundCloudWrapper.ApiAction<List<Track>>(ApiCall.MeTracks);
        }

        /// <summary>
        ///   Returns a collection of tracks.
        /// </summary>
        public static async Task<List<Track>> GetTracks()
        {
            return await SoundCloudWrapper.ApiAction<List<Track>>(ApiCall.Tracks);
        }
        ...
        public static async Task<Track> GetTrack(int id)
        {
            return await SoundCloudWrapper.ApiAction<Track>(ApiCall.Track, id);
        }
        ...
        public static async Task<List<Track>> Search(string term, string[] tags, Filter filter, string license, string order,
                                         ...
                                         DateTime to, int[] ids, string[] genres, string[] types, int offset = 0, int limit = 100)
        {
            ...
            return await SoundCloudWrapper.ApiAction<List<Track>>(ApiCall.Tracks, filters);
        }
        ...
        public void Add()
        {
            if (Uri != null && Title != null && Description != null && Sharing != null)
            {
                if (File.Exists(Path.GetFullPath(Uri)))
                {
                    ...
                    SoundCloudWrapper.ApiAction<Track>(ApiCall.Tracks, HttpMethod.Post, parameters);
                }
                else
                {
        ...
        public void Delete()
        {
            SoundCloudWrapper.ApiAction<Track>(ApiCall.Track, HttpMethod.DELETE, Id);
        }
...
/* Comment method
        ...
        {
            return await SoundCloudWrapper.ApiAction<List<Comment>>(ApiCall.TrackComments, Id);
        }
 */
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<List<User>> GetPermissions()
        {
            return await SoundCloudWrapper.ApiAction<List<User>>(ApiCall.TrackPermissions, Id);
        }
        ...
        {
            SoundCloudWrapper.ApiAction<Track>(ApiCall.MeFavoritesTrack, HttpMethod.PUT, Id);
        }
        ...
        {
            SoundCloudWrapper.ApiAction<Track>(ApiCall.MeFavoritesTrack, HttpMethod.DELETE, Id);
        }
        ...
        public void Share(Connection connection, string sharingNote)
        {
            ...
            SoundCloudWrapper.ApiAction<Track>(ApiCall.TrackShare, HttpMethod.POST, parameters, Id);
        }
         */
    }
}