...
namespace SoundCloud
{
    ...
    /// </summary>
    public sealed partial class App : Application, IApplicationController
    {
        ...
        public async void SetStartupPage()
        {
            ...
            ViewParams viewParams = new ViewParams() {Controller =  this, DataManager = _dataManager};
            if (loggedIn)
            {
                if (!rootFrame.Navigate(typeof(StreamPage), viewParams))
                {
            ...
            {
                if (!rootFrame.Navigate(typeof(LoginPage), viewParams))
                {
                    throw new Exception("Failed to create initial page");
                }
            }
        ...
        {
            ViewParams viewParams = new ViewParams() { Controller = this, DataManager = _dataManager };
            if (!rootFrame.Navigate(pageType, viewParams))
            {
